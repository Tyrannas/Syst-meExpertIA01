...
(setq *regles* '(
  ...
  (R110((equal armee polyvalente))(attaque 5))
  (R111((equal armee polyvalente))(defense 5))
  (R112((equal armee polyvalente))(distance 5))
  (R113((equal armee polyvalente))(portee 5))
  (R114((equal terrain plaine)(> nombre 0)) (espace (2)))
   
  (R115((equal terrain forteresse)(> archer 0)) (defense (3)))
  (R116((equal terrain forteresse)(> archer 0)) (portée (2)))
  (R117((equal environnement foret)(> elfe 0)) (attaque (2)))
  (R118((equal environnement foret)(> elfe 0)) (defense (2)))
  (R119((equal environnement souterrain)(> nain 0)) (defense (3)))
  (R120((equal environnement souterrain)(> gobelin 0)) (defense (2)))
  (R121((equal environnement souterrain)(> gobelin 0)) (attaque (2)))
  (R122((equal terrain forteresse)(> vitesse -800000)) (vitesse (-1)))
  (R123((equal terrain souterrain)(> nain 0)) (attaque (3))))
)
;;------------------------------bases de faits----------------------------------------
